        ...
        <div class="col-md-12">
          <div class="grid simple">
            <div class="grid-title">
              <h4>Complete this form to update your product.</h4>
            </div>
            <div class="grid-body">
              <div class="alert alert-info">
                <span><i class="fa fa-info-circle"></i>&nbsp;To change the product image, audio or video, select the files respectively and upload. To keep current image, audio and video files, leave the fields blank.</span>
              </div>
              <form id="product-form">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <button class="btn btn-large btn-cons btn-block btn-info" type="submit">
                          <i class="fa fa-upload">
                          </i>&nbsp;Update&nbsp;Product
                        </button>
                      </div>
                      <div class="col-md-6">
                        <button class="btn btn-large btn-cons btn-block btn-danger" type="reset">
...
<script src="/assets/js/pages/product/edit.min.js" type="text/javascript">
</script>
